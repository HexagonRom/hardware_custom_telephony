...
public class CustomExtTelephony extends IExtTelephony.Stub {
    ...
    private static CustomExtTelephony sInstance;
    ...
    public static CustomExtTelephony getInstance(Context context, Phone[] phones,
            CommandsInterface[] commandsInterfaces) {
        if (sInstance == null) {
            sInstance = new CustomExtTelephony(context, phones, commandsInterfaces);
        }

        return sInstance;
    }

    private CustomExtTelephony(Context context, Phone[] phones,
            CommandsInterface[] commandsInterfaces) {
